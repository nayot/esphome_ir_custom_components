...
//
// Example:
static const uint64_t CODE_OFF                = 0xA000AC0D0A350A00ULL; 
static const uint64_t CODE_COOL_22_AUTO       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_23_AUTO       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_24_AUTO       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_25_AUTO       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_26_AUTO       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_27_AUTO       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_22_LOW        = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_23_LOW        = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_24_LOW        = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_25_LOW        = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_26_LOW        = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_27_LOW        = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_22_MEDIUM     = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_23_MEDIUM     = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_24_MEDIUM     = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_25_MEDIUM     = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_26_MEDIUM     = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_27_MEDIUM     = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_22_HIGH       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_23_HIGH       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_24_HIGH       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_25_HIGH       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_26_HIGH       = 0xA090B20D05350500ULL;
static const uint64_t CODE_COOL_27_HIGH       = 0xA090B20D05350500ULL;
static const uint64_t CODE_FAN_ONLY_LOW       = 0xA090B20D05350500ULL;
static const uint64_t CODE_FAN_ONLY_MEDIUM    = 0xA090B20D05350500ULL;
static const uint64_t CODE_FAN_ONLY_HIGH      = 0xA090B20D05350500ULL;
static const uint64_t CODE_FAN_ONLY_AUTO      = 0xA090B20D05350500ULL;
